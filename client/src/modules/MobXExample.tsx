...
const MobXExample = MobXObserver(() => {
    ...
    return <div className='mobx-page-wrapper'>
        <div className='mobx-page'>
        <SimpleButton        
            variant="outlined"
            onClick={(e) => progressBarStore.setLoadingState(!progressBarStore.loading)}>
            {
        ...
        <SimpleButton
            variant="outlined"
            onClick={(e) => snackbarStore.isOpen ? snackbarStore.closeMessage() : snackbarStore.showMessage("Custom message", 'info')}>
            {
